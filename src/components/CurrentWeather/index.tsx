	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.currentTemperatureContainer}>
				<Text style={styles.currentTemperature}>{data.temperature}</Text>
				<Text style={styles.temperatureUnit}>{data.temperatureUnit}</Text>
			</View>
			...
			<View style={styles.infoContainer}>
				<Text style={styles.smallText}>Feels like {data.feelsLike}</Text>
				<Fontisto
					style={styles.dot}
					name="genderless"
					size={20}
					color="#fefefe"
				/>
				<Text style={styles.smallText}>Sunset {sunset}</Text>
			</View>
		</View>
	);
};
